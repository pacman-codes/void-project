...
PARTNER_OFFER_CODE = os.getenv("PARTNER_OFFER_CODE", "partner_offer_apr").strip()
PARTNER_OFFER_MAX_ASSIGNMENTS = as_int(os.getenv("PARTNER_OFFER_MAX_ASSIGNMENTS"), 15)
PARTNER_OFFER_PRICE_1M_RUB = as_int(os.getenv("PARTNER_OFFER_PRICE_1M_RUB"), 100)
PARTNER_OFFER_PRICE_6M_RUB = as_int(os.getenv("PARTNER_OFFER_PRICE_6M_RUB"), 600)
