...
def build_admin_help_text() -> str:
    return (
        ...
        "\n"
        "<b>Health / payments:</b>\n"
        "/adminHealth — статус сервисов, подписок и платежей\n"
        "/adminSmoke — запустить smoke-check из Telegram\n"
        "/adminPaymentCleanup [limit] — очистить зависшие pending-платежи\n"
        "/adminPaymentSync [telegram_id] — дожать успешный платёж вручную\n"
        "/adminTestPay [amount] — создать тестовый платёж для админа\n"
        "\n"
